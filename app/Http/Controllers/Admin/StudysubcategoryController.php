...
//__Store__//
    ...
    $notification = array('message' => 'Study Abroad Inserted Successfully', 'alert-type' => 'success');
...
//__DELETE__//
   ...
   {
    $study = Study::all();
    $studysubcategory = Studysubcategory::find($id);
    
    return view('admin.study.studysubcategory.edit', compact('studysubcategory', 'study'));
   }   
   ...
   {
       $studysubcategory = DB::table('studysubcategories')->where('id', $id)->first();
       $studysubcategory_image = $studysubcategory->studysubcategory_image;

       if (File::exists($studysubcategory_image)) {
            unlink($studysubcategory_image);
       }
       

       DB::table('studysubcategories')->where('id', $id)->delete();

       $notification = array('message' => 'Study Abroar Deleted Successfully', 'alert-type' => 'success');
       return redirect()->back()->with($notification);
   }    
